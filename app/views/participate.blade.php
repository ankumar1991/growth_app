        ...
        <div class="met_google_maps_52e8f1e7962af_met_contact_map_box met_contact_map_box met_bgcolor3 met_color2">
            <div class="met_contact_form">
                ...
                <div class="wpcf7" id="wpcf7-f4-p74-o1">
                    <form action="{{URL::to('contest/participate')}}" method="post" class="wpcf7-form"
                      ...
                      {{$errors->first('story')}}
                        ...
                        <p class="terms_p">
                            <label class="checkbox terms">
                                ...
                                <a href="{{URL::to('contest/terms')}}" target="_blank"
                                   style="color: #ffffff;text-decoration: underline">terms and conditions</a> of
                                the contest.
                            </label>
                        </p>
